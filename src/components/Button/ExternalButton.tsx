...
export default function Button({ type, children, href, className }: Props) {
  let styles;
  if (type === 'primary') {
    styles = `transition-all rounded-xl bg-brand-400 px-7 py-4 text-lg font-semibold text-black shadow-sm hover:brightness-[90%] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-200`;
