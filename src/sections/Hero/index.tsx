  ...
  return (
    <div className='relative md:min-h-[80vh] h-full bg-bottom bg-cover xl:bg-contain bg-green-bg'>
      <motion.div initial='offscreen'
          whileInView='onscreen' viewport={{amount: 0.4}} className='flex flex-col justify-center z-2 px-4 py-40 lg:px-32 lg:py-48'>
        <motion.h2 variants={fadeInVariant}  className='max-w-4xl mobile-header-light lg:h1-light'>
