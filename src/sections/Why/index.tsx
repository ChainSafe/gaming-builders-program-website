        ...
        <div className='grid grid-cols-1 items-center md:gap-x-8 lg:gap-x-16 gap-y-16 sm:gap-y-20 md:grid-cols-2 '>
          ...
          <div className='lg:max-w-lg'>
            ...
            <p className='h4-light opacity-80'>
              Our unique combination of capital and expertise in technical
              architecture and R&D has empowered numerous games to go web3 and
              beyond, accelerating your time-to-market and project impact
              significantly.
            </p>
          </div>
        </div>
